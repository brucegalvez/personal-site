...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  name: "".concat(name),
  labels: {
    es: ["Soy ", "Fullstack Web Developer.", "Comunicador.", "papá de Marty (mi gato).", "tu padre (NOOOOOOOOOOOOOOOO).", "fan de los Borbotones.", "la comadreja."],
